...
> ISO/IEC) plus a few foundational bandit-theory/V-model works. **50 references**, grouped by
> topic and mapped to the chapter/section where each is most likely to be cited, with a
> one-line note on *how* to use it.
>
> **Status:** none of these are in `writing/bibliography.bib` yet (it currently only has the
> template's placeholder entries). Once reviewed/trimmed, the next step is converting the kept
> entries into real `.bib` entries with the citation keys suggested below.
>
...
## A. Primary Related Work — Supervisor's Own Papers (cite throughout, especially Ch.1, Ch.3, Ch.7)
...
Sci. Educ. Technol. (ISCSET)*, 2024. DOI: 10.1109/ISCSET58624.2024.10807908.
Key: `datsogiannis2024early`
→ **Use:** the direct conceptual predecessor to this thesis (same supervisor, same CMAB +
ASPICE-derived + weighted-question + traffic-light-classification concept, same "seven
stakeholder roles" framing). Cite in Ch.1.3/1.4 when positioning your contribution, throughout
Ch.3 as the primary related work, and wherever your own design choices (reward function,
context-per-role, coverage incentive) echo this paper's concept. Full text and figure
descriptions already captured in
`supervisor_research_paper_new_approach_early_detection_vulnerabilities.md`.

**2.** 🟣 D. Datsogiannis and W. Hardt, "Recommender Systems for Reducing Software Fault Rates
in Automotive Software Development," in *Proc. Int. Symp. Comput. Sci. Educ. Technol.
(ISCSET)*, 2025. DOI: 10.1109/ISCSET65760.2025.11540532.
Key: `datsogiannis2025recommender`
→ **Use:** the direct sequel to [1] — cite in Ch.3 as related work, and centrally in Ch.7
(Discussion) / Ch.8 (Future Work) when addressing their **e-Greedy vs. LinUCB vs. Thompson
Sampling** simulated benchmark results (Table I) and their explicit "real-world evaluation
deferred to a future publication" framing, which your own pilot-based evaluation directly
supersedes. Full text, all figures, and Table I already captured in
`supervisor_research_paper_recommender_systems_fault_rates.md`.

---

## B. ASPICE, Standards & Certification (Ch.2.1 Background, throughout)

**3.** ✅🌐 **VDA QMC**, *Automotive SPICE® Process Assessment Model (PAM), Version 4.0*.
...
**4.** ✅ C. Murphy, "Automotive SPICE: 0-60 in No Time Flat," *IEEE Engineering Management
...
**5.** 🌐 ISO/IEC 33001:2015, *Information technology — Process assessment — Concepts and
...
**6.** 🌐 ISO/IEC 33020:2019, *Information technology — Process assessment — Process
...
**7.** 🌐 ISO 26262:2018, *Road vehicles — Functional safety*, 2nd ed. ISO, 2018.
Key: `iso26262_2018`
...
**8.** 🌐 VDA QMC / Automotive SPICE, official website. [Online]. Available:
...
**9.** 🌐 AUTOSAR, official website. [Online]. Available: https://www.autosar.org/
Key: `autosar_website`
...
**10.** 🌐 ISTQB (International Software Testing Qualifications Board), official website /
...
## C. Automotive Software Engineering & Motivation Background (Ch.1.1/1.2, Ch.2)

**11.** 🔵🟣 J. Schäuffele and T. Zurawka, *Automotive Software Engineering*. Springer
...
**12.** 🔵 *Automotive Systems and Software Engineering: State of the Art and Future Trends*.
Springer International Publishing, 2019. DOI: 10.1007/978-3-030-12157-0.
Key: `springer2019automotive_systems`
→ **Use:** Ch.2 background — companion citation to [11] above for broader automotive systems
engineering context, cited by the 2024 paper.

**13.** ✅🔵 Y. Zhang, T. Liu, H. Zhao, and C. Ma, "Risk analysis of can bus and ethernet
...
**14.** 🟣 M. L. Sichitiu and M. Kihl, "Inter-vehicle communication systems: a survey," *IEEE
...
[15] for intra-vehicle).

**15.** 🟣 S. Tuohy, M. Glavin, C. Hughes, E. Jones, M. Trivedi, and L. Kilmartin,
...
**16.** 🟣 S. Fürst, "Challenges in the design of automotive software," in *2010 Design,
...
**17.** 🟣 A. Iwai and M. Aoyama, "Automotive cloud service systems based on service-oriented
...
**18.** 🔵 W. Zhou and Z. Li, "Implementation and evaluation of smt-based real-time
...
## D. Software Metrics & Fault Prediction (Ch.3, contrast against your ASPICE-BP-based questions)

**19.** ✅🔵🟣 Z. H. Martinez, P. M. Moreno, J. A. Vergara Camacho, and G. C. Vega, "Study on
...
**20.** ✅🔵🟣 T. B. Alakus, R. Das, and I. Turkoglu, "An overview of quality metrics used in
...
→ **Use:** Ch.3 — companion citation to [19], same context.

**21.** ✅🔵 Y. Jiang, J. Lin, B. Cukic, S. Lin, and Z. Hu, "Replacing code metrics in software
...
**22.** 🔵🟣 J. Bansiya and C. G. Davis, "A hierarchical model for object-oriented design
...
**23.** 🟣 S. R. Chidamber, D. P. Darcy, and C. F. Kemerer, "Managerial use of metrics for
...
**24.** 🟣 R. Harrison, S. J. Counsell, and R. V. Nithi, "An evaluation of the mood set of
...
**25.** 🟣 M. Shepperd and D. Ince, *Derivation and validation of software metrics*. Oxford
...
**26.** 🟣 N. F. Schneidewind, "Methodology for validating software metrics," 1992.
Key: `schneidewind1992methodology`
→ **Use:** Ch.3 — companion citation to [25].

**27.** 🟣 S. Pandey, R. Mishra, and A. Tripathi, "Machine learning based methods for software
...
**28.** 🟣 I. Batool and T. A. Khan, "Software fault prediction using data mining, machine
...
→ **Use:** Ch.3 — companion survey citation to [27], same argument.

**29.** 🟣 V. Suma and T. Nair, "Defect management strategies in software development," *arXiv
...
**30.** 🟣 I. A. Memon, Q. B. Jamali, A. S. Jamali, M. K. Abbasi, N. A. Jamali, and Z. H.
...
**31.** ✅🔵 A. Haghighatkhah, M. Oivo, A. Banijamali, and P. Kuvaja, "Improving the state of
...
## E. Recommender Systems — General (Ch.2.2 Background)

**32.** 🟣 L. Lü, M. Medo, C. H. Yeung, Y.-C. Zhang, Z.-K. Zhang, and T. Zhou, "Recommender
...
**33.** 🟣 R. Bader, "Proactive recommender systems in automotive scenarios," Ph.D.
...
**34.** 🟣 K. Rama, P. Kumar, and B. Bhasker, "Deep learning to address candidate generation
...
**35.** 🟣 S.-M. Choi, D. Lee, K. Jang, C. Park, and S. Lee, "Improving data sparsity in
...
**36.** 🟣 Y. Bechavod, K. Ligett, A. Roth, B. Waggoner, and S. Z. Wu, "Equal opportunity in
...
## F. Multi-Armed Bandits, Contextual Bandits & Reinforcement Learning (Ch.2.3 — core algorithmic background)

**37.** ✅ L. Li, W. Chu, J. Langford, and R. E. Schapire, "A contextual-bandit approach to
...
**38.** 🟣 K.-H. Huang and H.-T. Lin, "Linear upper confidence bound algorithm for contextual
...
**39.** 🔵 N. Gutowski, T. Amghar, O. Camp, and F. Chhel, "Context enhancement for linear
...
**40.** ✅🔵 M. Naeem, S. T. H. Rizvi, and A. Coronato, "A gentle introduction to reinforcement
...
**41.** 🔵 J. Langford and T. Zhang, "The epoch-greedy algorithm for contextual multi-armed
...
**42.** 🟣 S. Agrawal and N. Goyal, "Thompson sampling for contextual bandits with linear
...
**43.** 🔵 M. Tokic and G. Palm, "Value-difference based exploration: adaptive control between
...
**44.** ✅ S. Zhong, W. Ying, X. Chen, and Q. Fu, "An Adaptive Similarity-Measuring-Based CMAB
...
**45.** 🔵 A. Agarwal, D. Hsu, S. Kale, J. Langford, L. Li, and R. E. Schapire, "Taming the
...
**46.** 🔵 A. Agarwal, S. Bird, M. Cozowicz, L. Hoang, J. Langford, S. Lee, J. Li, D. Melamed,
...
## G. V-Model & Foundational Bandit/RL Theory (Ch.2 background, Ch.2.3 — not sourced from either supervisor paper, added for completeness)

**47.** 🌐 P. Auer, "Using confidence bounds for exploitation-exploration trade-offs," *Journal
of Machine Learning Research*, vol. 3, pp. 397–422, 2002.
Key: `auer2002confidence`
→ **Use:** Ch.2.3.1/Ch.2.3.3 — the classical confidence-bound (UCB) theory that LinUCB
generalizes to the contextual/linear setting; a natural textbook-level citation to place just
before introducing LinUCB itself in Ch.2.3.3, since neither supervisor paper cites the
original UCB confidence-bound theory directly.

**48.** 🌐 R. S. Sutton and A. G. Barto, *Reinforcement Learning: An Introduction*, 2nd ed.
MIT Press, 2018.
Key: `sutton2018reinforcement`
→ **Use:** Ch.2.3 (opening) — the standard RL textbook; a good general citation to anchor
"reinforcement learning" terminology before narrowing into bandits specifically, complementing
the survey-style citation in [40].

**49.** 🌐 "V-Modell XT Bund." [Online]. Available: https://www.cio.bund.de/
Key: `vmodellxt_bund`
→ **Use:** Ch.2.1 background — the official German federal V-Model standard; cited by both
supervisor papers (2024 ref. [13], 2025 ref. [7]) whenever the V-model's role as the backbone
of automotive development is introduced, alongside your own framing of ASPICE capability
levels against V-model stages.

**50.** 🟣 S. Mathur and S. Malik, "Advancements in the v-model," *International Journal of
Computer Applications*, vol. 1, no. 12, pp. 29–34, 2010.
Key: `mathur2010vmodel`
→ **Use:** Ch.2.1 background — companion citation to [49], used by the 2025 supervisor paper
as their V-model reference; useful if you discuss V-model variations/adaptations rather than
only the base standard.
